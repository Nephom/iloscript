...
func printHelp() {
	...
	fmt.Println("  -devices                            Hardware report: firmware, storage, CPU, memory, NIC, power, chassis and PCIe.")
	...
	fmt.Println("  -firmware <image_path>... [--target auto|bios|ilo|manual]")
	fmt.Println("                                      Flash local images in the supplied order.")
	fmt.Println("  -firmware <folder> [--target auto|bios|ilo|manual]")
	...
	fmt.Println("  iloscript 192.0.2.10 -firmware ./fw1.bin ./fw2.bin")
	fmt.Println("  iloscript 192.0.2.10 -firmware ./firmware-folder")
